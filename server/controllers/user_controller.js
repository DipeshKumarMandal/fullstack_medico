...
export const loginDetails = async (req, res) => {
  try {
    ...
    if (match) {
      ...
      console.log("jwt token:",process.env.ACCESS_SECRET_KEY)
      ...
      console.log("This msg isfrom token formation-userController:",{msg: "Login Successful",
    ...
    console.log("access token",process.env.ACCESS_SECRET_KEY)
    console.log("THis  error is from logindetails:",error);
    return res.status(500).json({ msg: "internal server error", error });
  }
};
